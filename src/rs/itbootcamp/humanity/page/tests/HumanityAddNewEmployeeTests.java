...
public class HumanityAddNewEmployeeTests {
	...
	try {
		...
		HumanityStaff.inputFirstNameField(driver); //inputs the First name in the "First Name" field			
		HumanityStaff.inputLastNameField(driver); //inputs the Last name in the "Last Name" field
		HumanityStaff.inputEmailField(driver); //inputs email in the "Email" field
